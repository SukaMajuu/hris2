...
// Define the row type for table cells that need table state
interface TableRowPropsWithTable {
	row: {
		index: number;
...
// Define the row type for table cells that don't need table state
...
// Column components
const NoColumn = React.memo(({ row, table }: TableRowPropsWithTable) => {
