...
export const EmployeeInformationStep = ({
	formData,
	errors,
	onInputChange,
	onSelectChange,
			...
			<form>
				...
				<div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
					<div>
						...
						{!errors.employeeId &&
							getFieldValidationMessage("employee_code")}
					</div>
					<div>
						<label
							htmlFor="branch"
					...
					<div>
						...
						<p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
							Hire date is automatically set to today&apos;s date,
							you can change it later in Detail
						</p>
						{errors.hireDate && (
							<p className="mt-1 text-sm text-red-500">
