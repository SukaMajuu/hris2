		...
		api: {
			...
			checkClockOverview: {
				...
				approveReject: (id: number | string) =>
					`/api/check-clock/approval/${id}`,
				employeeRecords: (employeeId: string) =>
					`/api/employees/${employeeId}/check-clock`,
			},
			documents: {
				base: "/api/documents",
			...
			checkclockSettings: {
				...
				byEmployee: (employeeId: string) =>
					`/api/checkclock-settings/employee/${employeeId}`,
			},
			leaveRequests: {
			...
			attendances: {
				...
				byEmployee: (employeeId: number) =>
					`/api/attendances/employees/${employeeId}`,
			},
		},
	},
} as const;
