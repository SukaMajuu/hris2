...
import { LEAVE_TYPE, LeaveType } from "@/const/leave";
...
export const PermitDialog = React.memo(
	({
		open,
		onOpenChange,
		dialogTitle,
			...
			try {
				...
				if (dateError) {
					toast.error("Invalid Date Range", {
						description:
							"Please check the date range you selected.",
						duration: 4000,
					});
					return;
				}
								...
								: async (data) => {
										try {
											...
											toast.success(
												...
												{
													description:
														"Your attendance data has been successfully saved.",
													duration: 4000,
												}
											);
											...
											if (error instanceof Error) {
												// Error message will be handled by errorDescription
											} else if (
												typeof error === "object" &&
												error !== null
											) {
													...
													switch (
														...
														case 400: // Bad Request
															errorTitle =
																"Invalid Data";
															errorDescription =
																"The data you entered is invalid or incomplete.";
															if (
																errorResponse
																	.data
																	?.message
														...
														case 403: // Forbidden
															errorTitle =
																"Access Denied";
															errorDescription =
																"You do not have permission to save data.";
															break;
						...
						<div className="max-h-[calc(100vh-220px)] space-y-6 overflow-y-auto px-6 py-4">
							...
							<div className="rounded-lg bg-white p-6 shadow-md dark:bg-slate-800">
								<div className="space-y-2">
									...
									>
										<option value={LEAVE_TYPE.SICK_LEAVE}>
											Sick Leave
										</option>
										<option
											value={
										...
										<option value={LEAVE_TYPE.ANNUAL_LEAVE}>
											Annual Leave
										</option>
										<option
								...
								<div className="mt-4 space-y-2">
									...
									<Textarea
										...
										{...register("employee_note", {
											required:
												"Employee note is required",
											minLength: {
												value: 10,
												message:
													"Employee note must be at least 10 characters",
											},
										})}
									/>
