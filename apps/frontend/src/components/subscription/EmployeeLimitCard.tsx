...
export const EmployeeLimitCard: React.FC<EmployeeLimitCardProps> = ({
	className,
}) => {
	...
	const usagePercentage =
		limitInfo.maxCount > 0
			? Math.min((limitInfo.currentCount / limitInfo.maxCount) * 100, 100)
			: 0;
					...
					<div className="text-sm text-gray-600 dark:text-gray-400">
						<div className="mb-1 flex items-center justify-between">
							...
							<span className="font-medium">
								{limitInfo.tierInfo.minEmployees}-
								{limitInfo.tierInfo.maxEmployees} Employees
							</span>
						</div>
