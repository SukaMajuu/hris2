...
const SeatTierCardSkeleton: React.FC = () => (
		<Card className="w-full min-w-80 rounded-lg p-6 flex flex-col h-full shadow-md bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 animate-pulse">
			<CardHeader className="p-0 mb-3 pt-2">
				...
				<div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-md w-20 mb-3" />
				{/* Employee range skeleton */}
				<div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-md w-full mb-3" />
				{/* Pricing skeleton */}
			...
			<div className="mt-auto">
				{/* Button skeleton */}
				<div className="w-full h-10 bg-slate-200 dark:bg-slate-700 rounded-md" />
			</div>
		</Card>
	);
