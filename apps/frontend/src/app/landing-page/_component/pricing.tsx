      ...
      <div className='container mx-auto px-4'>
        <div className='mb-16 text-center'>
          ...
          <div className='mb-8 flex items-center justify-center'>
            <span className={`mr-3 ${isAnnual ? 'font-medium text-blue-800' : 'text-gray-500'}`}>
              Annual
            </span>
            <div
              onClick={() => setIsAnnual(!isAnnual)}
              className='relative h-7 w-14 cursor-pointer rounded-full bg-gray-200 transition-colors duration-300 ease-in-out'
            >
              <div
            ...
            <span className={`ml-3 ${!isAnnual ? 'font-medium text-blue-800' : 'text-gray-500'}`}>
              Monthly
            </span>
            {isAnnual && (
            ...
            >
              ...
              <div className='bg-white p-8'>
                ...
                <div className='mb-4 flex items-baseline'>
                  ...
                  <span className='ml-2 text-gray-600'>/ user / month</span>
                </div>
                <Button className='w-full'>{tier.ctaText}</Button>
              </div>
              <div className='bg-gray-50 p-8'>
                <p className='mb-4 font-medium text-gray-900'>Features include:</p>
                <ul className='space-y-3'>
                  {tier.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className='flex items-start'>
                      <Check size={18} className='mt-0.5 mr-2 flex-shrink-0 text-green-500' />
