...
export default function AddEmployeePage() {
	...
	return (
		<div className="max-w-auto mx-auto">
			<div className="bg-white px-4 py-3 mb-4 rounded-md">
			...
			<div className="mb-6 flex w-full items-center justify-center">
				{steps.map((step, idx) => (
					<Fragment key={step.label}>
						...
						{idx < steps.length - 1 && (
							<div className="mt-4 h-0.5 w-16 self-start bg-gray-300" />
						)}
					</Fragment>
				))}
			</div>
				...
				{activeStep === 1 && (
					<>
						...
						<Separator
							...
							className="mx-auto my-2 w-48 bg-gray-300"
						/>
						<form>
				...
				>
					<AlertDialogTrigger asChild>
						<Button
							type="button"
							variant="outline"
							className="bg-[#c7d3dd] text-black"
						>
							Close
						</Button>
					</AlertDialogTrigger>
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>
								All entered data will be discarded.
							</AlertDialogDescription>
						</AlertDialogHeader>
						<AlertDialogFooter>
							<AlertDialogCancel className="hover:bg-blue-500">
								Close
							</AlertDialogCancel>
							<AlertDialogAction
