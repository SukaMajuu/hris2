...
export const useEmployeeStore = create<EmployeeState>((set) => ({
  ...
  setEmployees: (employees, total) => set({ employees, totalEmployees: total, isLoading: false }),
  ...
  setSelectedEmployee: (employee) => set({ selectedEmployee: employee, isDetailLoading: false }),
