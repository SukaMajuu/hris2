	...
	<div className="min-h-screen bg-slate-100 dark:bg-slate-950 p-4 md:p-8 animate-pulse">
		<div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 items-start">
			...
			<div className="md:col-span-2 bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg">
				...
				<div className="mb-6">
					<div className="h-8 bg-slate-200 dark:bg-slate-700 rounded-md w-48 mb-2" />
					<div className="h-4 bg-slate-200 dark:bg-slate-700 rounded-md w-72 mb-3" />
					<div className="h-8 bg-slate-200 dark:bg-slate-700 rounded-md w-24" />
				</div>

				{/* Billing Period Section */}
				<div className="mt-8">
					<div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-md w-32 mb-4" />
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						{Array.from({ length: 2 }, (_, index) => (
							...
							>
								<div className="h-5 bg-slate-200 dark:bg-slate-700 rounded-md w-16 mb-2" />
				...
				{/* Team Size Section */}
				<div className="mt-8">
					<div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-md w-24 mb-2" />
					<div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-md w-48 mb-3" />
				...
				{/* Features Section */}
				<div className="mt-8">
					<div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-md w-36 mb-4" />
					<div className="space-y-3">
						{Array.from({ length: 4 }, (_, index) => (
							...
							>
								<div className="w-2 h-2 bg-slate-200 dark:bg-slate-700 rounded-full mt-2 flex-shrink-0" />
								<div className="flex-1">
									<div className="h-4 bg-slate-200 dark:bg-slate-700 rounded-md w-full mb-1" />
									<div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-md w-3/4" />
								</div>
							</div>
						))}
					</div>
			...
			<div className="md:col-span-1 bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg space-y-4">
				...
				<div className="border-b border-slate-200 dark:border-slate-700 pb-3">
					<div className="h-7 bg-slate-200 dark:bg-slate-700 rounded-md w-32" />
				</div>
				...
				<div className="flex justify-between">
					<div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-md w-12" />
