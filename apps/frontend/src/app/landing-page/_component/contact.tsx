        ...
        <div className='flex flex-col lg:flex-row'>
          <div className='mb-10 lg:mb-0 lg:w-1/2 lg:pr-16'>
            ...
            <p className='mb-8 text-lg text-gray-600'>
              Schedule a personalized demo or contact us to learn how HRIS can help streamline your
            ...
            <div className='rounded-lg bg-gray-50 p-6'>
              ...
              <ol className='space-y-3'>
                ...
                <li className='flex items-start'>
                  ...
                  <p className='text-gray-600'>
                    We&apos;ll guide you through implementation and setup
                  </p>
                </li>
              </ol>
            </div>
            ...
            {submitted ? (
              <div className='py-10 text-center'>
                ...
                <p className='mb-6 text-gray-600'>
                  Your demo request has been submitted successfully. A member of our team will
                  contact you shortly.
                </p>
              ...
              <>
                <h3 className='mb-6 text-2xl font-bold text-gray-900'>Request a Demo</h3>
