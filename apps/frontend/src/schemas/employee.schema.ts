...
export const employeeFormSchema = z.object({
  ...
  lastEducation: z
    .union([
      z.literal(''),
      z.enum(['SD', 'SMP', 'SMA/SMK', 'D1', 'D2', 'D3', 'S1/D4', 'S2', 'S3', 'Other']),
    ])
    .refine((val) => val !== '', { message: 'Education level is required' }),
  ...
  taxStatus: z
    ...
    .refine((val) => val !== '', { message: 'Tax status is required' }),
  ...
  contractType: z
    .union([z.literal(''), z.enum(['permanent', 'contract', 'freelance'])])
