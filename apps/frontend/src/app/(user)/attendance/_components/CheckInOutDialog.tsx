      ...
      <DialogContent className='bg-slate-50 p-0 sm:max-w-[700px] dark:bg-slate-900'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
          <div className='max-h-[calc(100vh-220px)] space-y-6 overflow-y-auto px-6 py-4'>
            ...
            <div className='rounded-lg bg-white p-6 shadow-md dark:bg-slate-800'>
              <div className='space-y-2'>
                ...
                >
                  {actionType === 'check-in' && <option value='check-in'>Check-In</option>}
                  {actionType === 'check-out' && <option value='check-out'>Check-Out</option>}
                </select>
              </div>
            </div>
            ...
            <div className='rounded-lg bg-white p-6 shadow-md dark:bg-slate-800'>
              ...
              <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
                <div className='space-y-1'>
                  <Label htmlFor='workType' className='text-xs text-slate-500 dark:text-slate-400'>
                    Work Type
                  </Label>
                  <Input
                    id='workType'
            ...
            <div className='space-y-4 rounded-lg bg-white p-6 shadow-md dark:bg-slate-800'>
              ...
              <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
                <div className='space-y-1'>
                  <Label htmlFor='latitude' className='text-xs text-slate-500 dark:text-slate-400'>
                    Latitude
                  </Label>
                  <Input
                    id='latitude'
                ...
                <div className='space-y-1'>
                  <Label htmlFor='longitude' className='text-xs text-slate-500 dark:text-slate-400'>
                    Longitude
                  </Label>
                  <Input
                    id='longitude'
          ...
          <DialogFooter className='rounded-b-lg border-t bg-slate-100 px-6 py-4 dark:border-slate-700 dark:bg-slate-800/50'>
            ...
            <Button type='submit' className='bg-[#6B9AC4] text-white hover:bg-[#5A89B3]'>
