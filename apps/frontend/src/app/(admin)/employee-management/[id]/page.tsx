				...
				<CardContent className="p-6">
					<div className="flex flex-col items-start gap-6 md:flex-row md:items-center">
						...
						>
							...
							{editJob && (
								<label
									htmlFor="profileImageTop"
									className="bg-opacity-50 absolute inset-0 flex cursor-pointer items-center justify-center rounded-full bg-black opacity-0 transition-opacity duration-200 group-hover:opacity-100"
								>
									...
									{editJob ? (
										<div className="relative">
											<Input
												...
												className={(() => {
													const baseClasses =
														"mt-1 h-8 border-slate-300 bg-slate-50 pr-8 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-800";
									...
									<Button
										...
										className={(() => {
											...
											if (
												...
												return `${baseClasses} cursor-not-allowed bg-slate-400 text-slate-600`;
											}
