...
import { PermitDialog } from "@/app/(user)/attendance/_tabsContent/leaveRequestTab/_components/PermitDialog";
...
export const UserDashboardCharts = ({
	selectedMonth,
	onMonthChange,
	monthYearOptions,
								...
								<div className="relative" ref={dropdownRef}>
									...
									>
										...
										<span className="flex items-center truncate font-medium text-gray-700">
											...
											{isLoadingMonthlyStats && (
												<div className="ml-2 h-3 w-3 animate-spin rounded-full border-b border-gray-400" />
											)}
										</span>{" "}
										<ChevronDown
												...
												{validMonthYearOptions.map(
													(option) => (
														...
														>
															{option.value ===
																selectedMonth && (
																<span className="mr-3 inline-block h-2 w-2 rounded-full bg-blue-500" />
															)}
															{option.label}
														</button>
													)
							...
							<div className="mb-6 grid grid-cols-2 gap-4">
								...
								<div className="rounded-xl border border-red-100 bg-gradient-to-br from-red-50 to-white p-5 transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
									<div className="mb-3 flex items-center">
										<div className="mr-3 h-3 w-3 rounded-full bg-red-500" />
										<p className="text-sm font-semibold text-red-700">
											Taken
										</p>
									</div>
									<p className="mb-3 text-2xl font-bold text-gray-900">
										{getAnnualLeaveData().totalDaysUsed}{" "}
										Days
									</p>
								...
								<div className="rounded-xl border border-green-100 bg-gradient-to-br from-green-50 to-white p-5 transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
									...
									<p className="mb-4 text-2xl font-bold text-gray-900">
										{getAnnualLeaveData().remainingDays}{" "}
										Days
									</p>
									<button
										type="button"
