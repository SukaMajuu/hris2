...
export default function ProfilePage() {
  ...
  if (!employee) {
    return (
      <div className='p-6 text-center text-slate-500 dark:text-slate-400'>Profile not found.</div>
    );
  }
        ...
        <Card className='border border-slate-100 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900'>
          ...
          <CardContent className='space-y-4'>
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              ...
              <div>
                <Label htmlFor='gender' className='text-slate-600 dark:text-slate-400'>
                  Gender
                </Label>
                {editPersonal ? (
              ...
              <div>
                <Label htmlFor='placeOfBirth' className='text-slate-600 dark:text-slate-400'>
                  Place of Birth
                </Label>
                <Input
                  id='placeOfBirth'
              ...
              <div>
                <Label htmlFor='dateOfBirth' className='text-slate-600 dark:text-slate-400'>
                  Date of Birth
                </Label>
                <Input
                  id='dateOfBirth'
                ...
                {editPersonal ? (
                  <Select value={lastEducation} onValueChange={setLastEducation}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value='SMA/SMK'>SMA/SMK (Senior High School)</SelectItem>
                      ...
                      <SelectItem value='S1/D4'>S1/D4 (Bachelor Degree)</SelectItem>
                      <SelectItem value='S2'>S2 (Master Degree)</SelectItem>
        ...
        <Card className='border border-slate-100 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900'>
          ...
          <CardContent className='space-y-4 p-6'>
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
              ...
              <div>
                <Label htmlFor='bankAccountHolder' className='text-slate-600 dark:text-slate-400'>
                  Account Holder Name
                </Label>
                <Input
