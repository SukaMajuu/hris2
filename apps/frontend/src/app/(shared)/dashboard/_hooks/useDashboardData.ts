...
export const useDashboardData = () => {
	...
	const {
		data: hireDateRange,
		isLoading: isLoadingHireDateRange,
	} = useHireDateRangeQuery();

	const {
		data: employeeStatsOverall,
		isLoading: isLoadingStatsOverall,
	} = useEmployeeStatsQuery();

	const {
		data: employeeStatsForChart,
		isLoading: isLoadingStatsForChart,
	} = useEmployeeStatsQuery(selectedMonthForEmployeeStatsChart);

	const {
		data: employeeStatsForStatusChart,
