...
export const TableHeader = ({
	...
	const getExportColumns = () => [
		...
		{
			key: "employee_code" as keyof ReturnType<
				typeof prepareExportData
			>[0],
		...
		{
			key: "place_of_birth" as keyof ReturnType<
				typeof prepareExportData
			>[0],
			header: "Place of Birth",
		},
		{
			key: "date_of_birth" as keyof ReturnType<
				typeof prepareExportData
			>[0],
			header: "Date of Birth",
		},
		{
			key: "last_education" as keyof ReturnType<
				typeof prepareExportData
			>[0],
			header: "Last Education",
		},
		{
			key: "contract_type" as keyof ReturnType<
				typeof prepareExportData
			>[0],
			header: "Contract Type",
		},
		{
			key: "resignation_date" as keyof ReturnType<
				typeof prepareExportData
			>[0],
		...
		{
			key: "bank_account_number" as keyof ReturnType<
				typeof prepareExportData
			>[0],
			header: "Bank Account Number",
		},
		{
			key: "bank_account_holder_name" as keyof ReturnType<
				typeof prepareExportData
			>[0],
			...
			<div className="flex w-full flex-row flex-wrap items-center justify-between gap-4">
				...
				<div className="flex flex-wrap gap-2">
					...
					<Link href="/employee-management/add">
						<Button className="cursor-pointer gap-2 bg-primary hover:bg-primary/90">
								...
								<div className="space-y-2">
									...
									>
										...
										<SelectContent>
											<SelectItem
												value="all"
												className="focus:bg-primary/80 cursor-pointer hover:text-white focus:text-white"
											>
												All Genders
											</SelectItem>
											<SelectItem
