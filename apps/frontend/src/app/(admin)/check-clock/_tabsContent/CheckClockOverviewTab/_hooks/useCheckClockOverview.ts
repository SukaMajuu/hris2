...
const useCheckClockOverview = (initialPage = 1, initialPageSize = 10) => {
	const [page, setPage] = useState(initialPage);
	const [pageSize, setPageSize] = useState(initialPageSize);
	const [, setSelectedRecord] = useState<CombinedAttendanceData | null>(null);
	const [, setIsDetailSheetOpen] = useState(false);
...
export default useCheckClockOverview;
