...
=======
  ...
  const barData = {
    ...
    datasets: [
      {
        label: 'Employees',
        data: [dashboardStats?.newHires, dashboardStats?.activeEmployees, dashboardStats?.resignedEmployees],
  ...
  // Handle error state
  if (statsError && isAdminDashboard) {
...
=======
            value={statsLoading ? '...' : dashboardStats?.newHires || 0}
>>>>>>> Stashed changes
...
=======
            value={statsLoading ? '...' : dashboardStats?.activeEmployees || 0}
>>>>>>> Stashed changes
...
=======
            value={statsLoading ? '...' : dashboardStats?.resignedEmployees || 0}
>>>>>>> Stashed changes
