...
) => useQuery<PaginatedResponse<CheckClockOverviewItem>, Error>({
...
export const useCheckClockEntryDetail = (id: number | string | null | undefined) => useQuery<CheckClockOverviewItem, Error>({
